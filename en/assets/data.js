// Demo data for the pattern atlas — Korver Machinebouw, Helmond.
// Fictional family business, ~85 employees, three generations, special machines
// for packaging lines in the food industry.
// All names, project codes and numbers are made up.

window.PA = window.PA || {};

// Internal hourly rate to value hour overruns in euro.
// Not payroll cost, but the margin impact per extra hour spent (loaded rate
// including overhead allocation). A plausible value for a Dutch manufacturer
// of 50–200 employees.
window.PA.UURTARIEF_INTERN = 60;

// Sub-sector per customer. Five categories across the food industry that
// these fictional customers serve. Used for color and grouping in the
// customers plot and the spread plot.
...
// Order of sub-sectors in legends and groupings (by customer count).
window.PA.subsectorVolgorde = ["Bakery", "Specialty", "Protein", "Dairy", "Sauces"];

// Color per sub-sector. Chosen for maximum mutual distinguishability within
// the palette, not for good/bad signaling.
window.PA.subsectorKleur = {
  "Bakery":    "#C98634",   // amber-500
  "Specialty": "#F2B969",   // amber-300
  "Protein":   "#1D0C0C",   // ink
  "Dairy":     "#6E8AA8",   // steel blue
  "Sauces":    "#3F7D4E",   // green
};

window.PA.projecten = [
  { id: "K2025-101", klant: "Brouwer Sauzen",        machine: "Filling station M40",   jaar: 2025, omzet: 1995000, margePercent: 22,  totaalUren: 16800, geplandeDoorlooptijdWeken: 18, werkelijkeDoorlooptijdWeken: 19,
  ...
  { id: "K2025-102", klant: "De Vegter Vleeswaren",  machine: "Sleeve machine S22",     jaar: 2025, omzet: 1680000, margePercent:  4,  totaalUren: 18760, geplandeDoorlooptijdWeken: 16, werkelijkeDoorlooptijdWeken: 24,
  ...
  { id: "K2025-103", klant: "Hoogland Zuivel",       machine: "Packaging line L100",   jaar: 2025, omzet: 2940000, margePercent: 23,  totaalUren: 25200, geplandeDoorlooptijdWeken: 26, werkelijkeDoorlooptijdWeken: 28,
  ...
  { id: "K2025-104", klant: "Westland Bakkerijen",   machine: "Tray loader T15",        jaar: 2025, omzet: 1015000, margePercent: 24,  totaalUren:  8400, geplandeDoorlooptijdWeken: 12, werkelijkeDoorlooptijdWeken: 12,
  ...
  { id: "K2025-105", klant: "Bos Snacks",            machine: "Packing robot R5",       jaar: 2025, omzet:  665000, margePercent:  8,  totaalUren:  6440, geplandeDoorlooptijdWeken: 10, werkelijkeDoorlooptijdWeken: 14,
  ...
  { id: "K2025-106", klant: "Den Hartog Conserven",  machine: "Labeling machine E12",   jaar: 2025, omzet: 1176000, margePercent: 17,  totaalUren:  9660, geplandeDoorlooptijdWeken: 14, werkelijkeDoorlooptijdWeken: 15,
  ...
  { id: "K2025-107", klant: "Verlinden Vis",         machine: "Stretch wrapper W8",     jaar: 2025, omzet:  770000, margePercent: -3,  totaalUren: 10360, geplandeDoorlooptijdWeken: 11, werkelijkeDoorlooptijdWeken: 19,
  ...
  { id: "K2025-108", klant: "Akkermans Suikerwerk",  machine: "Filling station M60",   jaar: 2025, omzet: 2380000, margePercent: 19,  totaalUren: 20300, geplandeDoorlooptijdWeken: 22, werkelijkeDoorlooptijdWeken: 23,
  ...
  { id: "K2025-109", klant: "Ravenstein Banket",     machine: "Tray loader T15",        jaar: 2025, omzet:  924000, margePercent: 21,  totaalUren:  7560, geplandeDoorlooptijdWeken: 11, werkelijkeDoorlooptijdWeken: 11,
  ...
  { id: "K2025-110", klant: "Vink Diepvries",        machine: "Packaging line L100",   jaar: 2025, omzet: 2765000, margePercent:  7,  totaalUren: 26600, geplandeDoorlooptijdWeken: 24, werkelijkeDoorlooptijdWeken: 32,
  ...
  { id: "K2025-111", klant: "Smaakhuis Groothandel", machine: "Labeling machine E12",   jaar: 2025, omzet:  616000, margePercent: 12,  totaalUren:  5460, geplandeDoorlooptijdWeken:  9, werkelijkeDoorlooptijdWeken: 10,
  ...
  { id: "K2025-112", klant: "Klaver Kruiden",        machine: "Packing robot R5",       jaar: 2025, omzet:  532000, margePercent: 28,  totaalUren:  4480, geplandeDoorlooptijdWeken:  8, werkelijkeDoorlooptijdWeken:  8,
  ...
  { id: "K2025-113", klant: "Brouwer Sauzen",        machine: "Labeling machine E12",   jaar: 2025, omzet: 1092000, margePercent: 15,  totaalUren:  9240, geplandeDoorlooptijdWeken: 13, werkelijkeDoorlooptijdWeken: 14,
  ...
  { id: "K2025-114", klant: "Veldhuis Banket",       machine: "Tray loader T15",        jaar: 2025, omzet:  700000, margePercent: 18,  totaalUren:  5880, geplandeDoorlooptijdWeken: 11, werkelijkeDoorlooptijdWeken: 11,
  ...
  { id: "K2024-091", klant: "Brouwer Sauzen",        machine: "Filling station M40",   jaar: 2024, omzet: 1876000, margePercent: 20,  totaalUren: 15960, geplandeDoorlooptijdWeken: 18, werkelijkeDoorlooptijdWeken: 19,
  ...
  { id: "K2024-088", klant: "De Vegter Vleeswaren",  machine: "Sleeve machine S22",     jaar: 2024, omzet: 1505000, margePercent: 11,  totaalUren: 14700, geplandeDoorlooptijdWeken: 16, werkelijkeDoorlooptijdWeken: 18,
  ...
  { id: "K2024-082", klant: "Hoogland Zuivel",       machine: "Tray loader T15",        jaar: 2024, omzet:  966000, margePercent: 22,  totaalUren:  7980, geplandeDoorlooptijdWeken: 12, werkelijkeDoorlooptijdWeken: 12,
  ...
  { id: "K2024-085", klant: "Westland Bakkerijen",   machine: "Tray loader T15",        jaar: 2024, omzet:  994000, margePercent: 25,  totaalUren:  8260, geplandeDoorlooptijdWeken: 12, werkelijkeDoorlooptijdWeken: 12,
  ...
  { id: "K2024-079", klant: "Bos Snacks",            machine: "Packing robot R5",       jaar: 2024, omzet:  714000, margePercent: 14,  totaalUren:  6160, geplandeDoorlooptijdWeken: 10, werkelijkeDoorlooptijdWeken: 11,
  ...
  { id: "K2024-077", klant: "Den Hartog Conserven",  machine: "Labeling machine E12",   jaar: 2024, omzet: 1064000, margePercent: 16,  totaalUren:  8820, geplandeDoorlooptijdWeken: 14, werkelijkeDoorlooptijdWeken: 14,
  ...
  { id: "K2024-076", klant: "Bremer Frisdrank",      machine: "Filling station M40",   jaar: 2024, omzet: 1610000, margePercent: 15,  totaalUren: 13860, geplandeDoorlooptijdWeken: 17, werkelijkeDoorlooptijdWeken: 18,
  ...
  { id: "K2024-073", klant: "Verlinden Vis",         machine: "Stretch wrapper W8",     jaar: 2024, omzet:  868000, margePercent:  9,  totaalUren:  8680, geplandeDoorlooptijdWeken: 11, werkelijkeDoorlooptijdWeken: 14,
  ...
  { id: "K2024-071", klant: "Akkermans Suikerwerk",  machine: "Filling station M60",   jaar: 2024, omzet: 2240000, margePercent: 17,  totaalUren: 19460, geplandeDoorlooptijdWeken: 22, werkelijkeDoorlooptijdWeken: 22,
  ...
  { id: "K2024-068", klant: "Ravenstein Banket",     machine: "Tray loader T15",        jaar: 2024, omzet:  896000, margePercent: 19,  totaalUren:  7560, geplandeDoorlooptijdWeken: 11, werkelijkeDoorlooptijdWeken: 12,
  ...
  { id: "K2024-064", klant: "Vink Diepvries",        machine: "Sleeve machine S22",     jaar: 2024, omzet: 1386000, margePercent: 13,  totaalUren: 12880, geplandeDoorlooptijdWeken: 15, werkelijkeDoorlooptijdWeken: 17,
  ...
  { id: "K2024-062", klant: "Smaakhuis Groothandel", machine: "Labeling machine E12",   jaar: 2024, omzet:  658000, margePercent: 14,  totaalUren:  5740, geplandeDoorlooptijdWeken:  9, werkelijkeDoorlooptijdWeken: 10,
  ...
  { id: "K2024-059", klant: "Klaver Kruiden",        machine: "Packing robot R5",       jaar: 2024, omzet:  504000, margePercent: 26,  totaalUren:  4340, geplandeDoorlooptijdWeken:  8, werkelijkeDoorlooptijdWeken:  8,
